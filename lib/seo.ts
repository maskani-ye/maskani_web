...
> = {
  properties: {
    ...
    description:
      "شقق وفلل وأراضٍ ومحلات في صنعاء وعدن وتعز وإب وكل المحافظات — بالسعر والصور والموقع على الخريطة، ورقم صاحب العقار مباشرةً بلا عمولة.",
    keywords: [
  ...
  services: {
    ...
    description:
      "تحتاج مقاولاً أو سبّاكاً أو كهربائياً؟ تواصل مباشرةً برقم المزوّد في محافظتك، وشاهد تقييمات من تعاملوا معه ومعرض أعماله قبل أن تتّفق — بلا عمولة.",
    keywords: [
