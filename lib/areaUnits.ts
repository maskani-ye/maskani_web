...
//   official   — قيمة معياريّة بالتعريف لا تختلف (المتر، الهكتار، الفدان المصريّ).
//   documented — القيمة المعمول بها فعلاً في الإقليم ويتعامل بها المسّاحون والسوق.
//                لا يلزم أن تصدر عن جهة حكومية كي تكون صحيحة — العرف المستقرّ هو
//                المرجع في هذه البلدان، وعليه تُبرم الصفقات وتُكتب البصائر.
//   local      — تتغيّر من مديريّة لأخرى؛ خُذها استئناساً واسأل مسّاح الموقع.
...
export const COUNTRIES: Country[] = [
  { code: "YE", name: "اليمن", flag: "🇾🇪", hint: "اليمن أكثر البلاد تعدّداً في الوحدات: لكل إقليم لبنته وقصبته بقيمة مختلفة ومستقرّة يتعامل بها المسّاحون والسوق — اختر اشتقاق منطقتك بالاسم، ولا تعتمد رقماً عامّاً." },
...
export const BASIS_LABEL: Record<Basis, string> = {
  official: "قيمة معياريّة ثابتة",
  documented: "القيمة المعتمدة في الإقليم",
  local: "تختلف بين المديريّات",
};
