 ...
 *
 * الحلّ: وكيل Cloudflare يضع دولة الزائر في ترويسة، فنقرأها ونصيّر
...
export async function detectMarket(): Promise<Market> {
  ...
  try {
    ...
    // ⚠️ **`cf-ipcountry` وحدها.** الترويسة تأتي من شبكة Cloudflare التي يمرّ
    // بها كل طلب؛ وإضافة ترويسة مزوّدٍ آخر توهم القارئ بمسارٍ حيّ لا وجود له.
