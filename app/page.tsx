...
export const metadata: Metadata = {
  ...
  keywords: [
    // ⚠️ البوّابة تفتح ستّة أسواق، وكانت كلماتها تذكر اثنين — فتخسر أربعة
    // استعلامات قُطرية كاملة على الصفحة الوحيدة التي تملك سُلطة الجذر.
    "مسكني", "maskani", "عقارات",
    "عقارات السعودية", "عقارات الأردن", "عقارات مصر",
