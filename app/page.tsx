...
const PILLARS = [
  {
    key: "properties",
    ar: { name: "العقارات", body: "شقق وأراضٍ وبيوت ومحلات للبيع والإيجار، بتواصل مباشر مع صاحب العقار — الصورة والسعر والموقع من مالكه لا من وسيط." },
    en: { name: "Properties", body: "Apartments, land, houses and shops for sale and rent — you reach the owner directly, not a middleman." },
    href: "/properties",
  },
  {
    key: "services",
    ar: { name: "الخدمات", body: "مقاولون وفنّيون ومكاتب هندسية وخدمات يومية في مدينتك، بتقييمات من عملاء حقيقيين وسجلّ أعمال ظاهر." },
    en: { name: "Services", body: "Contractors, technicians and everyday services in your city — with real client ratings and visible past work." },
    href: "/services",
  },
  {
    key: "requests",
    ar: { name: "طلبات العقارات", body: "لا تبحث بنفسك: اكتب ما تريده وميزانيتك ومدينتك، ويصلك أصحاب العقارات المطابقة بعروضهم." },
    en: { name: "Property requests", body: "Stop searching: post what you need and your budget, and matching owners come to you." },
    href: "/requests",
  },
  {
    key: "jobs",
    ar: { name: "طلبات الخدمات", body: "اطلب خدمة — صيانة أو نقل أو تصميم — واستقبل عروض المزوّدين المناسبين لمدينتك وقارِن بينها." },
    en: { name: "Service requests", body: "Ask for a service — repair, moving, design — and compare offers from providers in your city." },
    href: "/jobs",
  },
];
