...
export const metadata: Metadata = {
  title: "مدونة مسكني — أدلّة ونصائح العقارات في اليمن",
  description:
    "مقالات وأدلّة عقارية في اليمن: شراء وبيع وإيجار، أدلّة المدن، اتجاهات الأسعار، ونصائح تجنّب الاحتيال العقاري — من فريق مسكني.",
  keywords: [
    "مدونة عقارية", "نصائح عقارات اليمن", "دليل شراء عقار", "أسعار العقارات",
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
      ...
      <header className="mb-8">
        ...
        <p className="text-gray-600 mt-2 max-w-2xl leading-relaxed">
          أدلّة ونصائح عقارية موثوقة في اليمن — شراء، بيع، إيجار، أدلّة المدن، وحماية من الاحتيال.
