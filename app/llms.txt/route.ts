...
> منصّة عقارية عربية تربط صاحب العقار بالباحث عنه **مباشرةً** — بلا عمولة على
> الصفقة وبلا بوّابة دفع. تغطّي اليمن والسعودية والأردن ومصر والعراق وعُمان،
...
- [كل العقارات](${BASE}/sa/properties): فلترة بالمدينة والحيّ ونوع العقار ونوع
  العرض والسعر والمساحة وعدد الغرف. **بدّل رمز السوق في المسار**
  (\`/ye\` · \`/sa\` · \`/jo\` · \`/eg\` · \`/iq\` · \`/om\`) لتصفّح سوقٍ آخر — كل سوق
  موقعٌ قائم بذاته بمدنه وعملته.
- [طلبات الباحثين](${BASE}/sa/requests): من يبحث عن عقار ينشر طلبه فيصله الملّاك.
- [مزوّدو الخدمات العقارية](${BASE}/sa/services): صيانة · نقل · تشطيب، بتقييمات.
