...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-8">
      <header>
        <h1 className="text-h2 sm:text-h1 font-extrabold text-ink mb-3">من نحن</h1>
        <p className="text-muted-600 leading-relaxed">
          <strong>مسكني</strong> منصّة عقارية عربية تصل صاحب العقار بالباحث عنه
          مباشرةً — بلا عمولة، وبلا بوّابة دفع. تنشر عقارك أو خدمتك أو
          طلبك، فيراك من يبحث عنه في مدينتك ويتواصل معك على رقمك.
        </p>
      </header>

      <section className="space-y-3">
        <h2 className="text-h3 font-bold text-ink">ما الذي نحلّه</h2>
        <p className="text-muted-600 leading-relaxed">
        ...
        <ul className="space-y-2 text-muted-600 leading-relaxed list-disc ps-6">
          <li>
      ...
      <section className="space-y-3">
        <h2 className="text-h3 font-bold text-ink">أين نعمل</h2>
        <p className="text-muted-600 leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-h3 font-bold text-ink">ماذا نقدّم</h2>
        <ul className="space-y-2 text-muted-600 leading-relaxed list-disc ps-6">
      ...
      <section className="rounded-2xl bg-cream border border-muted-100 p-5">
        <h2 className="text-h3 font-bold text-ink mb-2">للتواصل</h2>
        <p className="text-muted-600 leading-relaxed">
