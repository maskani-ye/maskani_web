...
import ConstructionCostCalc from "@/components/tools/ConstructionCostCalc";

const tool = toolBySlug("construction-cost")!;
...
export default function Page() {
  return <ToolPage tool={tool}><ConstructionCostCalc /></ToolPage>;
}
