...
import RentAffordabilityCalc from "@/components/tools/RentAffordabilityCalc";

const tool = toolBySlug("rent-affordability")!;
...
export default function Page() {
  return <ToolPage tool={tool}><RentAffordabilityCalc /></ToolPage>;
}
