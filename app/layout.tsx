...
export const metadata: Metadata = {
  ...
  title: {
    default: "مسكني | عقارات اليمن — بيع وإيجار شقق وأراضٍ وخدمات",
    template: "%s | مسكني",
  },
  description: "مسكني منصة عقارية يمنية: شقق وأراضٍ وفلل للبيع والإيجار في صنعاء وعدن وتعز وكل المحافظات، مع خدمات عقارية ومجتمع لمكافحة الاحتيال العقاري.",
  keywords: [
