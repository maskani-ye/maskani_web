...
export const metadata: Metadata = {
  ...
  // ⚠️ **لا `canonical` في الغلاف الجذر.** كان `canonical: "/"` هنا، فورثته كل
  // صفحةٍ لا تُعرّف قانونيّتها الخاصّة — فأعلنت أنّها **نسخةٌ من الصفحة
  // الرئيسية**. وهو ما أبلغت عنه Search Console: «نسخة طبق الأصل، لم يخترها
  // المستخدم نسخة أساسية». `‎/terms` و`‎/privacy` و`‎/help` كانت تُنكر نفسها
  // وتحيل جوجل إلى الجذر، فلا تُفهرَس أبداً.
  //
  // القانونيّة تُعرَّف **في الصفحة** التي تخصّها. والغلاف يبقي `languages`
  // وحدها لأنّها تصف الموقع كلّه لا صفحةً بعينها.
  alternates: { languages: { ar: "/" } },
  robots: {
    index: true,
    follow: true,
    googleBot: {
