...
// حدّ خطأ عام لصفحات المستخدم — يظهر عند فشل تحميل أي صفحة مع زر إعادة المحاولة
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center" dir="rtl">
      ...
      <p className="text-sm text-gray-500 mb-6 max-w-sm">
        تعذّر تحميل هذه الصفحة. أعد المحاولة، وإن استمرّت المشكلة تواصل مع فريق الدعم.
      </p>
