...
export function ImproveTextButton({
  ...
  return (
    <button
      ...
      className={
        className ??
        "inline-flex shrink-0 whitespace-nowrap items-center gap-1.5 rounded-lg bg-primary/10 text-primary px-3 py-1.5 text-caption font-semibold hover:bg-primary/20 transition-colors disabled:opacity-60"
      }
    >
