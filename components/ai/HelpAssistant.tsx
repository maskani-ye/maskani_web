...
export function HelpAssistant() {
  ...
  return (
    <div className="bg-white rounded-2xl card-shadow p-4 mb-4">
      <h2 className="font-bold text-gray-800 flex items-center gap-1.5 mb-2 text-sm">
      ...
      <div className="flex items-stretch gap-2">
        <input
          ...
          className="flex-1 border border-gray-200 rounded-xl px-3 text-sm h-10 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
        />
        <button
          type="button"
          onClick={ask}
      ...
      {answer && (
        <div className="mt-3 rounded-xl bg-primary/5 border border-primary/15 p-3 text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">
          {answer}
        </div>
      )}
