...
export default function AreaConverter({
  ...
  //
  // عنصر الشبكة (وكذلك المرن) لا يتقلّص دون عرض محتواه افتراضياً، فأيّ `select`
  // بخياراتٍ طويلة أو صفّ شرائح يفرض عرضه على الشبكة كلّها — وتخرج الزيادة في
  // RTL من اليسار بإحداثيّ سالب فتمتدّ مساحة تمرير المستند. `min-w-0` على
  // الأبناء يسمح لهم بالتقلّص فيلتفّ المحتوى.
  //
  // (ظننتُ السبب `min-w-[420px]` على جدول التحويل فأصلحتُه، فبقي الانزلاق 52
  // بكسلاً وكشف أنّ المسؤول غيره — والقياس بعد النشر هو ما منع ادّعاء الإصلاح.)
  return (
