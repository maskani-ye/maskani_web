...
<svg xmlns="http://www.w3.org/2000/svg" width="30" height="42" viewBox="0 0 30 42" fill="none">
  <path d="M15 0C6.716 0 0 6.716 0 15c0 10.5 15 27 15 27s15-16.5 15-27C30 6.716 23.284 0 15 0z" fill="#2D6A4F"/>
  <circle cx="15" cy="15" r="6" fill="#D4A017"/>
</svg>`;

/** أيقونة الإعلان (نقطة واحدة) بألوان مسكني */
export const listingIcon: L.DivIcon = L.divIcon({
